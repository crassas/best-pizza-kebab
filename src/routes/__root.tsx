...
import { RestaurantDataProvider } from "@/lib/restaurant-context";
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:image", content: "https://bestpizzaandkebab.pt/og.jpg" },
    ],
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Figtree:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap" },
    ],
  }),
  component: () => (
